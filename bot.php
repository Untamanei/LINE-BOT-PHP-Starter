...
if($arrJson['events'][0]['message']['text'] == "wi"){
  ...
  $arrPostData['messages'][0]['originalContentUrl'] = "https://image.goosiam.com/view.asp?uid=434280&s=YQne6iEKCwc2";
  $arrPostData['messages'][0]['previewImageUrl'] = "https://image.goosiam.com/view.asp?uid=434280&s=YQne6iEKCwc2";
  //$arrPostData['messages'][0]['type'] = "text";
